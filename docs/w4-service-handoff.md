...
2026-09-17 추가: W3 C01 r2를 사용하는 서버 입력 0.2·출력 0.3은 [C01 연결 안내](w4-c01-integration-2026-09-17.md)를 따른다.
아래 내용은 기존 서버 입력 0.1·출력 0.2의 계약과 시연이다. 공개 요청과 URL은 두 경로에서 동일하다.
